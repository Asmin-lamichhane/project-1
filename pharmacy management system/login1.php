...
<div class="header">
<h1 style="position: absolute; top: 0; left: 50%; transform: translateX(-50%); font-size: 40px;">PHARMACY MANAGEMENT SYSTEM</h1>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        $error_message = "No account found with the given username or Employee ID.";
    }
